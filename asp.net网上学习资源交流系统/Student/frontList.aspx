	...
	<div class="col-md-9 wow fadeInLeft">
		...
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%#(((Container.ItemIndex+0)%4==0)?"style='clear:left;'":"") %>>
			  <a href="frontshow.aspx?studentNumber=<%#Eval("studentNumber")%>"><img class="img-responsive" src="../<%#Eval("userPhoto")%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		学号: <%#Eval("studentNumber")%>
			     	</div>
			     	<div class="field">
	            		姓名: <%#Eval("name")%>
			     	</div>
			        ...
			        <a class="btn btn-primary top5" href="frontShow.aspx?studentNumber=<%#Eval("studentNumber")%>">详情</a>
			        <a class="btn btn-primary top5" onclick="studentEdit('<%#Eval("studentNumber")%>');" style="display:none;">修改</a>
			        <a class="btn btn-primary top5" onclick="studentDelete('<%#Eval("studentNumber")%>');" style="display:none;">删除</a>
			     </div>
			</div>
			</ItemTemplate>
			</asp:Repeater>
	...
	<div class="col-md-3 wow fadeInRight">
		<div class="page-header">
			...
			<div class="form-group">
				...
				<asp:TextBox ID="studentNumber" runat="server"  CssClass="form-control" placeholder="请输入学号"></asp:TextBox>
			</div>
			<div class="form-group">
...
function studentEdit(studentNumber) {
	$.ajax({
		url :  basePath + "Student/StudentController.aspx?action=getStudent&studentNumber=" + studentNumber,
		type : "get",
		dataType: "json",
