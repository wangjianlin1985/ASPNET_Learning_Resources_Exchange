...
namespace DAL
{
    ...
    public class dalTeacher
    {
        ...
        {
            string sql = "insert into Teacher(teacherNo,password,name,gender,birthDate,teacherPhoto,telephone,email) values(@teacherNo,@password,@name,@gender,@birthDate,@teacherPhoto,@telephone,@email)";
            /*构建sql参数*/
            ...
            parm[3].Value = teacher.gender; //性别
        ...
        public static ENTITY.Teacher getSomeTeacher(string teacherNo)
        {
            ...
            if (DataRead.Read())
            {
                ...
                teacher.gender = DataRead["gender"].ToString();
        ...
        {
            string sql = "update Teacher set password=@password,name=@name,gender=@gender,birthDate=@birthDate,teacherPhoto=@teacherPhoto,telephone=@telephone,email=@email where teacherNo=@teacherNo";
            /*构建sql参数信息*/
            SqlParameter[] parm = new SqlParameter[] {
             new SqlParameter("@password",SqlDbType.VarChar),
             new SqlParameter("@name",SqlDbType.VarChar),
