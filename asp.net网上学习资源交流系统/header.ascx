...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">学习资源交流网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Question/frontlist.aspx">问题交流</a></li>
                 <!--<li><a href="<%=basePath %>Reply/frontlist.aspx">答复</a></li>
                <li><a href="<%=basePath %>ResourceType/frontlist.aspx">资源分类</a></li>-->
                <li><a href="<%=basePath %>Resource/frontlist.aspx">学习资源</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>Student/frontAdd.aspx"  ><i class="fa fa-sign-in"></i>&nbsp;&nbsp;学生注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Question/frontStudentAdd.aspx"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我要提问</a></li>
                        <li><a href="<%=basePath %>Question/frontStudentList.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我提的问题</a></li>
                        <li><a href="<%=basePath %>Resource/frontStudentAdd.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;发布资源</a></li>
                        <li><a href="<%=basePath %>Resource/frontStudentList.aspx"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我发布的资源</a></li>
