<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReplyList.aspx.cs" Inherits="chengxusheji.Admin.ReplyList" %>
   ...
   <form id="form1" runat="server">
    ...
    <div class="Body_Title">答复管理 》》答复列表</div>
     <div class="Body_Search">
        ...
        回答的老师&nbsp;&nbsp;<asp:DropDownList ID="teacherObj" runat="server"></asp:DropDownList>  &nbsp;&nbsp;
    ...
    <asp:Repeater ID="RpReply" runat="server" onitemcommand="RpReply_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="ReplyEdit.aspx?replyId=<%#Eval("replyId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("replyId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
