...
namespace chengxusheji.Admin
{
    public partial class QuestionList : System.Web.UI.Page
    {
        ...
        protected void BtnAllDel_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
            {
                try
                {
                    ...
                    {
                        Common.ShowMessage.Show(Page, "suess", "信息成功删除..", "QuestionTeacherList.aspx");
                    }
                    else
                    {
        ...
        protected void RpQuestion_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "Del")
            {
                try
                {
                    ...
                    {
                        Common.ShowMessage.Show(Page, "seuss", "信息删除成功...", "QuestionTeacherList.aspx");
                    }
                    else
                    {
                        Common.ShowMessage.Show(Page, "seuss", "信息删除失败，请重试或联系管理人员...", "QuestionTeacherList.aspx");
                    }
                }
                catch
                {
        ...
        {
            Response.Redirect("QuestionTeacherList.aspx?title=" + title.Text.Trim()  + "&&studentObj=" + studentObj.SelectedValue.Trim()+ "&&questionTime=" + questionTime.Text.Trim());
        }
