<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionTeacherList.aspx.cs" Inherits="chengxusheji.Admin.QuestionList" %>
    ...
    <asp:Repeater ID="RpQuestion" runat="server" onitemcommand="RpQuestion_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="QuestionTeacherEdit.aspx?questionId=<%#Eval("questionId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("questionId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
