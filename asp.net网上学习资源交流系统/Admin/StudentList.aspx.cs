...
namespace chengxusheji.Admin
{
    public partial class StudentList : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("StudentList.aspx?studentNumber=" + studentNumber.Text.Trim() + "&&name=" + name.Text.Trim()+ "&&birthDate=" + birthDate.Text.Trim()+ "&&telephone=" + telephone.Text.Trim());
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < studentDataSet.Tables[0].Rows.Count; i++)
            {
                ...
                sb.Append("<td>" + dr["studentNumber"].ToString() + "</td>");
